...
The version is `6.1.0` rather than `6.0.14` on purpose: this release contains a new feature and three backward-incompatible changes, which is a minor bump under the [versioning scheme](https://github.com/wgzhao/Addax/blob/master/README.md#-versioning-scheme).
...
版本号定为 `6.1.0` 而不是 `6.0.14` 是有意的:本版本包含新特性与三处不兼容变更,按[版本命名规范](https://github.com/wgzhao/Addax/blob/master/README_zh.md#%E7%89%88%E6%9C%AC%E5%91%BD%E5%90%8D%E8%A7%84%E8%8C%83)应走小版本号。

...
public class HbaseSQLReaderTask
{
    ...
    private void constructRecordFromPhoenix(com.alibaba.datax.common.element.Record record, Map<String, Object> phoenixRecord)
            throws IOException
    {
    ...
    public boolean readRecord(com.alibaba.datax.common.element.Record record)

...
public final class StockUtil
{
    ...
    /** Nextstockcode. */
    public static String nextStockCode(RandomGenerator rng)
    {
        return CommonUtil.randChoose(rng, CODE_PREFIXES) + RandomStringUtils.insecure().nextNumeric(4);
    }

    /** Nextstockaccount. */
    public static String nextStockAccount(RandomGenerator rng)
    {
        return CommonUtil.randomDigitalString(rng, 10);
    }
}

        ...
        extends Reader
{
    ...
    private static final DataBaseType DATABASE_TYPE = DataBaseType.DuckDB;
            ...
            extends Reader.Job
    {
        ...
        public void init()
        {
            ...
            // DuckDB authenticates nobody, but the shared reader rejects a blank username
            this.originalConfig.set(Key.USERNAME, "addax");
            this.originalConfig.set(Key.PASSWORD, "");
            ...
            extends Reader.Task
    {
        ...
        public void init()
        {
            ...
            this.commonRdbmsReaderTask = new DuckdbReaderTask(DATABASE_TYPE, getTaskGroupId(), getTaskId());

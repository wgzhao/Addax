...
import com.wgzhao.addax.plugin.writer.starrockswriter.util.StarRocksWriterErrorCode;
    ...
    private void validateRequired() {
       final String[] requiredOptionKeys = new String[]{
        ...
        for (String optionKey : requiredOptionKeys) {
            options.getNecessaryValue(optionKey, StarRocksWriterErrorCode.REQUIRED_VALUE);
        }
    }
}

...
package com.wgzhao.datax.plugin.writer.ftpwriter;
...
import com.wgzhao.datax.plugin.writer.ftpwriter.util.Constant;
import com.wgzhao.datax.plugin.writer.ftpwriter.util.IFtpHelper;
import com.wgzhao.datax.plugin.writer.ftpwriter.util.SftpHelperImpl;
import com.wgzhao.datax.plugin.writer.ftpwriter.util.StandardFtpHelperImpl;
...
import static com.wgzhao.datax.plugin.storage.writer.Key.SUFFIX;
import static com.wgzhao.datax.plugin.storage.writer.Key.WRITE_MODE;

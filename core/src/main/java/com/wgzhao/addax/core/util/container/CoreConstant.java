...
public class CoreConstant
{
    ...
    public static final String DATAX_HOME = System.getProperty("addax.home");
    ...
    public static final String DATAX_PLUGIN_READER_HOME = StringUtils.join(
            new String[] {DATAX_PLUGIN_HOME, "reader"}, File.separator);

    public static final String DATAX_PLUGIN_WRITER_HOME = StringUtils.join(
            new String[] {DATAX_PLUGIN_HOME, "writer"}, File.separator);

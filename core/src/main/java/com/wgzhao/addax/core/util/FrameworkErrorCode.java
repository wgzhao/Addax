        ...
        implements ErrorCode
{
    ...
    //	INSTALL_ERROR("Framework-00", "Addax 引擎安装错误, 请联系您的运维解决 ."),
...
//    HOOK_FAIL_ERROR("Framework-06", "执行外部Hook出现错误"),
    ...
    //    PLUGIN_NOT_FOUND("Framework-11", "Addax 插件配置错误, 该问题通常是由于Addax 安装错误引起，请联系您的运维解决 ."),
    ...
    PLUGIN_DIRTY_DATA_LIMIT_EXCEED("Framework-14", "Addax 传输脏数据超过用户预期，该错误通常是由于源端数据存在较多业务脏数据导致，请仔细检查Addax 汇报的脏数据日志信息, 或者您可以适当调大脏数据阈值 ."),
...
//    START_TASKGROUP_ERROR("Framework-17", "taskGroup启动失败,请联系Addax 开发团队解决"),
//    CALL_ADDAX_SERVICE_FAILED("Framework-18", "请求 Addax  Service 出错."),
